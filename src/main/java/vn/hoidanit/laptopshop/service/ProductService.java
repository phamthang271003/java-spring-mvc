...
public class ProductService {
    ...
    public Page<Product> handleGetAllProductWithSpec(Pageable page, ProductCriteriaDTO productCriteriaDTO) {
    ...
    // public Page<Product> handleGetAllProductWithSpec(Pageable pageable, double
    // minPrice) {
    ...
    // public Page<Product> handleGetAllProductWithSpec(Pageable pageable, String
    // factory) {
    // return this.productRepository.findAll(ProductSpecs.matchFactory(factory),
    // pageable);
    // }

    // public Page<Product> handleGetAllProductWithSpec(Pageable pageable,
    // List<String> fatories) {
    // return
    // this.productRepository.findAll(ProductSpecs.matchListFactory(fatories),
    // pageable);
    // }
